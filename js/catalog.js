...
function addSelectedItemToCart() {
  ...
  selectedQuantity = parseInt(document.getElementById('quantity').value);
  clickCounter++;
...
function updateCartPreview() {
  ...
  let result = document.getElementById('cartContents');
  let ulElement = document.createElement('ul');
  result.appendChild(ulElement);
  ulElement.textContent = `${selectedQuantity} ${selectedItem} was selcted `;
}
